...
import { Loader2, Send, ZapIcon, Sparkles, RefreshCw, Copy, Check, MessageCircle, MessageSquare } from "lucide-react";
import { useToast } from "@/components/ui/use-toast";
import { Switch } from "@/components/ui/switch";
import { Label } from "@/components/ui/label";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { enhancePromptWithClaude, savePromptHistory, getPromptHistory } from "@/utils/api";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-zinc-50 p-6 animate-fade-in">
      <Card className="w-full max-w-4xl shadow-lg border-0 overflow-hidden backdrop-blur-sm bg-white/90 animate-slide-up">
        ...
        <CardContent className="pt-6 space-y-6">
          <Tabs defaultValue="conversation" value={activeTab} onValueChange={selectTemplate}>
              ...
              <div className="border rounded-lg bg-zinc-50/80 h-[320px] overflow-y-auto p-4 space-y-4">
                {messages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-zinc-400 space-y-2">
                    ...
                    <p>Your conversation with Claude will appear here.</p>
                    <p className="text-xs">Ask anything to get genius-level prompt enhancements!</p>
                  </div>
                ) : (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={`text-xs mt-1 ${
                          message.type === "user" ? "text-amber-100" : "text-zinc-500"
                        }`}>
                ...
                <div className="flex-grow space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <Label htmlFor="creativity" className="text-xs text-zinc-500">Creativity</Label>
                      <Slider
                        id="creativity"
                        value={creativity}
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="advanced-mode" className="text-xs text-zinc-500">Advanced</Label>
                    </div>
                  </div>
                  <Textarea
                    value={inputPrompt}
